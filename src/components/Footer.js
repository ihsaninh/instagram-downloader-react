            ...
            <div class="col-md-4 mt-3">
              ...
              <ul class="list-group ml-6">
                <li class="list-group-item">
                  <a href="https://www.facebook.com/ihsannhabib">
                    <i class="fab fa-fw fa-facebook-messenger"></i> Ihsan Nurul
                    Habib
                  </a>
                </li>
                <li class="list-group-item">
                  <a href="https://instagram.com/ihsan_inh/">
                    <i class="fab fa-fw fa-instagram"></i> ihsan_inh
                  </a>
                </li>
                <li class="list-group-item">
                  <a href="https://twitter.com/ihsan_inh">
                    <i class="fab fa-fw fa-twitter"></i> @ihsan_inh
                  </a>
                </li>
              </ul>
            </div>
              ...
              <div class="col">
                <p class="copy">
                  <small>
                    ...
                    <i class="fas fa-coffee"></i> in Bogor Indonesia
                  </small>
                </p>
              </div>
              <div class="col">
                <p class="copy text-right">
                  <small>Copyright 2019 InstaGan, Inc</small>
                </p>
              </div>
            </div>
          </div>
